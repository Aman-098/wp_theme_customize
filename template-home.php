        ...
        <div class="col-xxl-5">
          <!-- Header text content-->
            <?php
              ...
              $profile=get_field('profile-image'); 
              ...
              $socialicon_1=get_field('socialicon_1'); 
              $socialicon_2=get_field('socialicon_2'); 
              $socialicon_3=get_field('socialicon_3'); 
            ?>
          <div class="text-center text-xxl-start">
            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
              <div class="text-uppercase"><?php echo esc_html($designation); ?></div>
            </div>
            <div class="fs-3 fw-light text-muted">
            <?php echo esc_html($hero_subtitle); ?>
            </div>
            <h1 class="display-3 fw-bolder mb-5">
              <span class="text-gradient d-inline"><?php echo esc_html($hero_title); ?></span>
            </h1>
            <div
        ...
        <div class="col-xxl-7">
          ...
          <div class="d-flex justify-content-center mt-5 mt-xxl-0">
            <div class="profile bg-gradient-primary-to-secondary">
              ...
              <img
                class="profile-img"
                src="<?php echo esc_url($profile['url']); ?>"
                alt="..."
              />
              <div class="dots-1">
                <!-- SVG Dots-->
        ...
        <div class="col-xxl-8">
          <div class="text-center my-5">
            <h2 class="display-5 fw-bolder">
              <span class="text-gradient d-inline"><?php echo esc_html($about_title); ?></span>
            </h2>
            ...
            <div class="d-flex justify-content-center fs-2 gap-4">
              <a class="text-gradient" href="#!"
                ><i class="bi bi-<?= $socialicon_1 ?>"></i
              ></a>
              <a class="text-gradient" href="#!"
                ><i class="bi bi-<?= $socialicon_2 ?>"></i
              ></a>
              <a class="text-gradient" href="#!"
                ><i class="bi bi-<?= $socialicon_3 ?>"></i
              ></a>
            </div>
          </div>
        </div>
